...
const representative_entity_1 = require("../representatives/entities/representative.entity");
const deposit_entity_1 = require("../deposits/entities/deposit.entity");
const order_entity_1 = require("../orders/entities/order.entity");
let DashboardService = class DashboardService {
    constructor(quotationRepository, vehicleRepository, representativeRepository, depositRepository, orderRepository) {
...
exports.DashboardService = DashboardService = __decorate([
    ...
    __param(2, (0, typeorm_1.InjectRepository)(representative_entity_1.Representative)),
