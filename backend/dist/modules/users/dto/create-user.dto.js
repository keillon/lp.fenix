...
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'Perfil do usuário', enum: ['admin', 'manager', 'user'], default: 'user' }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsEnum)(['admin', 'manager', 'user']),
    __metadata("design:type", String)
], CreateUserDto.prototype, "role", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'Indica se o usuário está ativo', default: true }),
    (0, class_validator_1.IsOptional)(),
